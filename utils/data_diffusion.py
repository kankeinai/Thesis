...
class Diffusion1D(Dataset):
    ...
    def __init__(
        ...
        for _ in range(n_samples):
            ...
            if supervised:
                y = self._solve_diffusion_reaction(u)
...
def load_diffusion1d_dataset(filepath):
    """
    Load 1D heat equation dataset from HDF5 file and return a PyTorch Dataset object.
    """
    import h5py
    class Diffusion1DLoadedDataset(torch.utils.data.Dataset):
    ...
    return Diffusion1DLoadedDataset(filepath)

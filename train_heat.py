...
def main():
    ...
    root_dir     = Path("trained_models/heat1d")
    ...
    for ep in range(start_epoch, epochs + 1):
        ...
        with torch.no_grad():
            for u, y, _ in test_loader:
                ...
                te_phy_b.append(compute_residual_heat(pred, u_values, dx, dt, nu=0.01).pow(2).mean().item())

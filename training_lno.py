...
training(model, optimizer, scheduler, train_loader, test_loader, compute_loss['linear'], gradient_lno, architecture='lno', num_epochs=num_epochs, problem=problems[idx], w=[1, 1])
